                      ...
                      <?php foreach ($quotation_data['quotation_item'] as $key => $val): ?>
                       ...
                       <tr id="row_<?php echo $x; ?>">
                        ...
                        <div style="min-width:60px">
                          ...
                          <td>
                          <div style="min-width:60px">
                            <input type="text" name="qty[]" id="qty_<?php echo $x; ?>" value="<?php echo $val['qty']?>" class="form-control total_calculator_qty" required autocomplete="off">
                            </div>
                          </td>
