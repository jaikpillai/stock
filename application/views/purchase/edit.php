                  ...
                  <div class="col-sm-7">
                    <select class="form-control select_group party_select" id="party" name="party" style="width:100%;" required>
                      ...
                      <?php foreach ($party_data as $k => $v) : ?>
                        ...
                        <option value="<?php echo $v['party_id'] ?>" <?php if (($v['party_id'] == $purchase_data['purchase_master']['party_id'])) {
                    ...
                    <?php foreach ($purchase_data['purchase_item'] as $key => $val) : ?>
                      ...
                      <tr id="row_<?php echo $x; ?>">
                        ...
                        <td>
                          ...
                          <input type="number" name="rate[]" id="rate_<?php echo $x; ?>" class="form-control total_calculator_rate" value="<?php echo $val['rate'] ?>" autocomplete="off">
  ...
  $(document).ready(function() {
    ...
    $("#add_row").unbind('click').bind('click', function() {
      ...
      html += '</select>' +
        ...
        '<td><input type="number" name="rate[]" id="rate_' + row_id + '" class="form-control total_calculator_rate" ><input type="hidden" name="rate_value[]" id="rate_value_' + row_id + '" class="form-control"></td>' +
