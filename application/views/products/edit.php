          ...
          <form role="form" action="<?php base_url('users/update') ?>" method="post" enctype="multipart/form-data">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <select class="form-control select_group" id="category" name="category">
                  <?php foreach ($category as $k => $v) : ?>
                    <option value="<?php echo $v['id'] ?>" <?php if (in_array($product_data['Category_ID'], $v)) {
              ...
              <div class="form-group">
                ...
                <select class="form-control select_group" id="unit" name="unit">
                  <?php foreach ($unit_data as $k => $v) : ?>
                    <option value="<?php echo $v['sUnit'] ?>" <?php if (($unit_data_sUnit['sUnit'] == $v['sUnit'])) {
                                                                echo 'selected="selected"';
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" maxlength="12" id="item_hsn" name="item_hsn" value="<?php echo $product_data['Hsn_Code']; ?>" placeholder="Enter HSN" autocomplete="off" />
              </div>
              ...
              <div class="form-group">
                ...
                <select class="form-control select_group" id="tax" name="tax">
                  <?php foreach ($tax_data as $k => $v) : ?>
                    <option value="<?php echo $v['iTax_ID'] ?>" <?php if (($product_data['iTax_ID'] == $v['iTax_ID'])) {
                                                                  echo 'selected="selected"';
              ...
              <div class="form-group">
                ...
                <select class="form-control select_group" id="store" name="store">
                  <?php foreach ($stores as $k => $v) : ?>
                    <option value="<?php echo $v['id'] ?>" <?php if (in_array($product_data['Company_ID'], $v)) {
                                                              echo 'selected="selected"';
                                                            } ?>><?php echo $v['name'] ?></option>
